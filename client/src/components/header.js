            ...
            <div className="middle">
                ...
                <div className={"search-dropdown " + (searchActive?"active":"")} itemScope="" itemType="https://schema.org/WebSite">
                    ...
                    <div className="search-icon">
                        ...
                        {searchActive?
                            <svg className="me-5" width="19" onClick={() => setSearchActive(false)} height="17" viewBox="0 0 19 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
            ...
            <a href="/cart" className="cart">
                ...
                <div id="cart_line">
                    <div id="bx_basketFKauiI" className="bx-basket bx-opener">
                        ...
                        <span className="basket-circle">{basket.goods.length}</span></div>
                </div>
            </a>
        </header>
    );
